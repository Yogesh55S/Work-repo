...
export default function VerifyOTP() {
  ...
  const handleVerifyOTP = async () => {
    ...
    try {
      const res = await axios.post(`${import.meta.env.VITE_API_URL}/auth/verify-otp`, { email, otp });
  ...
  const handleResendOTP = async () => {
    setIsResending(true);
    try {
      const res = await axios.post(`${process.env.REACT_APP_API_URL}/auth/resend-otp`, { email });
