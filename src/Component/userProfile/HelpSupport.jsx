...
const HelpSupport = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Yes, detailed allergen information is available on each product page.",
    },
    {
      question: "What is the shelf life of your products?",
      answer: "Our products have a shelf life of 12-24 months depending on the type.",
    },
    {
    ...
    },
    {
      ...
      answer: "Please contact our support team for assistance with damaged products.",
    },
    {
    ...
    },
    {
      ...
      answer: "Yes, we ship to many countries worldwide. Please check our shipping policy.",
    },
  ];
  ...
  return (
    <div className="max-w-4xl  mx-auto">
      ...
      <div className="flex items-center ">
        <h1 className=" text-[#909F8C] md:text-xl font-semibold">Customer Support</h1>
        <img src={leftarrow} alt="left arrow" className="w-[100px] h-[70px] ml-2" />
      </div>
      ...
      <div className="flex items-center space-x-2 ">
        <h1 className=" text-[#909F8C] md:text-xl font-semibold ">Frequently Asked Questions (FAQs)</h1>
        <img src={leftarrow} alt="left arrow" className="w-[100px] h-[70px]" />
      </div>
