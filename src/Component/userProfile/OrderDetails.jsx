				...
				<div className="bg-white p-4 rounded-lg shadow-sm border border-amber-900 hover:shadow-md transition-shadow duration-300">
					...
					<div className="space-y-2 text-left">
						...
						<div className="flex items-center  text-black   p-2 rounded-md">
							...
							<span
								className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium shadow-sm ${getStatusBadgeStyle(orderDetails.status)}`}
							>
						...
						<div className="flex items-center  text-black p-1">
							...
							<span
								className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium shadow-sm ${getStatusBadgeStyle(orderDetails.paymentStatus)}`}
							>
								...
								<img
									src={
										item.productId.image
											? `${IMAGE_BASE_URL}/${item.productId.image.replace(/\\/g, "/")}`
