  ...
  return (
    <div className="py-5">
      <div className="max-w-7xl mx-auto">
        ...
        {successMessage && (
          <div className="bg-green-100 text-green-600 px-4 py-2 rounded mb-4">{successMessage}</div>
        )}
        {products.length === 0 ? (
          ...
          <div className="flex flex-col gap-6">
            {products.map((product) => (
              ...
              >
                <img
                  src={`${API_URL.replace("/api", "")}/${product.image.replace(/\\/g, "/")}`}
                ...
                <div className="p-4 flex flex-col justify-between flex-grow">
                  <div>
                    ...
                    <p className="text-gray-600 mt-1">
                      <strong>Type:</strong> {product.type} {product.subType && `> ${product.subType}`}
                    </p>
                    <p className="text-gray-600 mt-1">
