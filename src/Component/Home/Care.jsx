...
const careData = [
  {
    id: 1,
    title: "Body Care",
    description: "Indulge in the essence of nature with our nurturing body care range",
    image: goldOilImage,
    type: "Body Care",
  },
  {
    id: 2,
    title: "Skin Care",
    description: "Reveal your skin’s true radiance with our range of nurturing and homemade skincare products ",
    image: faceWashImage,
    type: "Skin Care",
  },
  {
    id: 3,
    title: "Hair Care",
    description: "Homemade products designed to combat dandruff, minimize hair loss, reverse premature graying, and enhance hair texture",
    image: goldOilImage,
    type: "Hair Care",
  },
  {
    id: 4,
    title: "Soap Bars",
    description: "Pamper your skin with our daily cleansing Ayurvedic soaps for nourished and revitalized skin",
    image: faceWashImage,
    type: "Soap Bars",
  },
];
