  ...
  return (
    <div className="bg-gray-50 py-16 px-4 md:px-6">
      <div className="max-w-[1240px] mx-auto">
        <h2 className="text-3xl md:text-5xl font-bold text-gray-800 text-center mb-8 md:mb-12">
          Our Care Collection
        </h2>
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center bg-black bg-opacity-30">
                <div className="text-left px-6 md:px-10">
                  <h3 className="text-xl md:text-5xl font-bold text-white mb-2 md:mb-4">{item.title}</h3>
