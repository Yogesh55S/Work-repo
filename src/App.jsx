...
const AdminPanel = lazy(() => import("./Pages/AdminPanal"));
...
const Settings = lazy(() => import("./Component/admin/Settings"));
...
const Payment = lazy(() => import("./Component/userProfile/Payment"));
